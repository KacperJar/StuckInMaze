...
import * as wasm2 from "/workspaces/StuckInMaze/node_modules/@dimforge/rapier3d/rapier_wasm3d_bg.wasm";
...
var RawDynamicRayCastVehicleController = class {
  ...
  update_vehicle(dt, bodies, colliders, queries, filter_flags, filter_groups, filter_predicate) {
    try {
      ...
      wasm.rawdynamicraycastvehiclecontroller_update_vehicle(this.__wbg_ptr, dt, bodies.__wbg_ptr, colliders.__wbg_ptr, queries.__wbg_ptr, filter_flags, isLikeNone(filter_groups) ? 4294967297 : filter_groups >>> 0, addBorrowedObject(filter_predicate));
    } finally {
      heap[stack_pointer++] = void 0;
    }
  }
